...
- [Model Context Protocol (MCP) Python SDK](https://github.com/modelcontextprotocol/python-sdk) - Python implementation of the Model Context Protocol for building MCP clients and servers with stdio, Streamable HTTP, and SSE transports. ([Source Code](https://github.com/modelcontextprotocol/python-sdk)) `MIT` `Python`
- [Model Context Protocol (MCP) reference servers](https://github.com/modelcontextprotocol/servers) - Collection of official reference implementations for MCP servers, including filesystem, git, memory, and time examples. ([Source Code](https://github.com/modelcontextprotocol/servers)) `Apache-2.0/MIT` `Python/Nodejs`
