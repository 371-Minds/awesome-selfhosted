...
- [MCP Python SDK](https://py.sdk.modelcontextprotocol.io/) - Python implementation of the Model Context Protocol for building MCP clients and servers (supports stdio, streaming HTTP, and SSE transports). ([Source Code](https://github.com/modelcontextprotocol/python-sdk)) `MIT` `Python`
- [MCP Reference Servers](https://modelcontextprotocol.io/) - Collection of official reference server implementations demonstrating MCP integration patterns with filesystem, git, memory, and time examples. ([Source Code](https://github.com/modelcontextprotocol/servers)) `Apache-2.0/MIT` `Python/Node.js`
