...
- [MCP Reference Servers](https://modelcontextprotocol.io/) - Collection of official reference server implementations demonstrating MCP integration patterns with filesystem, git, memory, and time examples. ([Source Code](https://github.com/modelcontextprotocol/servers)) `Apache-2.0/MIT` `Python/Nodejs`
